"""Task judge JSON contract helpers for DefenseAgent workflow."""
...
def task_judge_schema() -> dict[str, str]:
    """Return strict output schema for final task judge."""
    return {
        "task_result": "SUCCESS | FAIL",
        "analysis": "If FAIL, explain concrete failure factors.",
    }
